...
import { UserProfile, DeliveryAddress, ChangePass, History, WishList } from "../../components"
            ...
            <div className="user-section">
              ...
              <div className="user-section-container">            
                <div className="row row10">                
                  <div className="col-md-4 d-none d-md-block pad10">
                        <div className="profile-menu">
                          ...
                          <ul className="list-unstyled">
                            ...
                            <li>
                              <Link to={`${match.path}/wishlist`} className="flex-this">
                  ...
                  <Switch>
                    <Route exact path={`${match.url}`} component={UserProfile}></Route>
                    <Route exact path={`${match.url}/delivery`} component={DeliveryAddress}></Route>
                    <Route exact path={`${match.url}/password`} component={ChangePass}></Route>
                    <Route exact path={`${match.url}/history`} component={History}></Route>
                    <Route exact path={`${match.url}/wishlist`} component={WishList}></Route>
                  </Switch>
                </div>            
              </div>
            </div>
