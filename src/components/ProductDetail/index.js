...
//                           {product.measure} үнэ: {money.format(product.price)}₮
//                         </p>
//                       </div>
//                     </div>
...
//   getAll = () => {
//     api.product
//       .productCollection({ skucd: this.state.skucd })
//       .then(res => this.setState({ collectionProduct: res.data }));
//     api.product
//       .productAttribute({ skucd: this.state.skucd })
//       .then(res => this.setState({ attribute: res.data }));
//     api.product
//       .productRelational({ skucd: this.state.skucd })
//       .then(res => this.setState({ relationalProduct: res.data }));
//     api.product.productDetail({ skucd: this.state.skucd }).then(product =>
//       api.category.findAll().then(category => {
